...
namespace ElevationFramework\Lib\Plugins\Updater;
...
class Load
{
    ...
    public $repo = 'Elevation-Web/elevation-framework';
    public $slug = 'elevation';
    public $ver  = 1.2;
    public $url  = 'https://elevationframework.mystagingwebsite.com/';
